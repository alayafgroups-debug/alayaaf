...
export default function AccountActionsMenu({
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute left-0 top-full z-50 mt-1 w-64 rounded-lg border border-border bg-white shadow-lg" dir="rtl">
          {/* Edit */}
          <button
          ...
          {!canDelete && (
            <div className="mx-3 mb-2 rounded-md bg-amber-50 border border-amber-200 px-3 py-2 text-xs text-amber-700 text-right leading-relaxed">
          ...
          >
            ...
            <span>إضافة حساب فرعي كحساب بنك</span>
          </button>

          <div className="mx-3 mb-2 mt-1 text-xs text-muted-foreground text-right leading-relaxed">
            سيتم أيضاً إنشاء حساب بنكي في وحدة الحسابات البنكية. تتيح لك الحسابات البنكية تسجيل المعاملات المصرفية بسهولة واستيراد كشف الحساب ومطابقته.
          </div>
        </div>
      )}
    </div>
