...
type Employee = { id: string; empId: string; name: string; branch: string; administration: string; department: string; workLocation: string; workSchedule: string; workTime: string; dailyHours: number };
...
export default function HRAttendanceReport() {
  ...
  const filteredEmployees = employees.filter((employee) => (branch === ALL || employee.branch === branch) && (administration === ALL || employee.administration === administration) && (department === ALL || employee.department === department) && (workLocation === ALL || employee.workLocation === workLocation) && (workTime === ALL || employee.workTime === workTime));
