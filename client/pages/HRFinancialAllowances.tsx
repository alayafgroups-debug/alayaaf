...
const mockAllowances = [
  { id: 1, nameAr: "بدل سكن", nameEn: "House allowance", value: "%25" },
  { id: 2, nameAr: "بدل مواصلات", nameEn: "Transportation allowance", value: "SAR 500.00" },
  { id: 3, nameAr: "بدل إعاشة", nameEn: "Food Allowance", value: "SAR 200.00" },
  { id: 4, nameAr: "بدل إعاشة", nameEn: "Food Allowance", value: "SAR 300.00" },
];

export default function HRFinancialAllowances() {
  ...
  return (
    <div className="space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-900">قائمة البدلات</h1>
          ...
          <DialogContent className="sm:max-w-[425px]">
            ...
            <div className="grid gap-4 py-4">
              <div className="space-y-2">
                ...
                <Input placeholder="أدخل الوصف بالعربية" />
              </div>
              <div className="space-y-2">
                <label className="text-sm font-medium">الوصف بالإنجليزية</label>
                <Input placeholder="أدخل الوصف بالإنجليزية" />
              </div>
              <div className="space-y-2">
                <label className="text-sm font-medium">قيمة البدل</label>
                <Input placeholder="أدخل قيمة البدل" />
              </div>
      ...
      <div className="bg-white rounded-md border shadow-sm">
        ...
        <Table>
          <TableHeader className="bg-[#004e89]">
            <TableRow>
              ...
              <TableHead className="text-white text-right">قيمة البدل</TableHead>
          ...
          <TableBody>
            {mockAllowances.map((allowance) => (
              <TableRow key={allowance.id}>
                <TableCell className="font-medium">{allowance.id}</TableCell>
                <TableCell>{allowance.nameAr}</TableCell>
                <TableCell>{allowance.nameEn}</TableCell>
        ...
        <div className="p-4 border-t flex justify-between items-center text-sm text-gray-500">
          <div>إظهار 1 إلى 4 من أصل 4 مدخل</div>
