...
const mockDeductions = [
  { id: 1, description: "التأمين الطبي", value: "SAR 0.00" },
  { id: 2, description: "عقوبة جزاء", value: "SAR 0.00" },
];

export default function HRFinancialDeductions() {
  ...
  return (
    <div className="space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-900">أنواع الاقتطاعات المالية</h1>
        <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
          ...
          <DialogContent className="sm:max-w-[425px]">
            <DialogHeader>
              <DialogTitle>إضافة نوع اقتطاع مالي</DialogTitle>
            </DialogHeader>
            <div className="grid gap-4 py-4">
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium">قيمة الاقتطاع</label>
                <Input placeholder="أدخل قيمة الاقتطاع" />
              </div>
      ...
      <div className="bg-white rounded-md border shadow-sm">
        ...
        <Table>
          <TableHeader className="bg-[#004e89]">
            <TableRow>
              ...
              <TableHead className="text-white text-right">قيمة الاقتطاع</TableHead>
        ...
        <div className="p-4 border-t flex justify-between items-center text-sm text-gray-500">
          <div>إظهار 1 إلى 2 من أصل 2 مدخل</div>
