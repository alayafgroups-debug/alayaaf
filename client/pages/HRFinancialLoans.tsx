...
const mockLoans = [
  { id: 1, description: "قرض سكني" },
  { id: 2, description: "قرض شخصي" },
  { id: 3, description: "قرض سيارة" },
  { id: 4, description: "قرض دراسة" },
  { id: 5, description: "أخرى" },
];

export default function HRFinancialLoans() {
  ...
  return (
    <div className="space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-900">قائمة أنواع السلف</h1>
      ...
      <div className="bg-white rounded-md border shadow-sm">
        ...
        <div className="p-4 border-t flex justify-between items-center text-sm text-gray-500">
          <div>إظهار 1 إلى 5 من أصل 5 مدخل</div>
