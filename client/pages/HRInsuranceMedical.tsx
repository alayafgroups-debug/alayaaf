...
export default function HRInsuranceMedical() {
  const [searchTerm, setSearchTerm] = useState("");

  const mockData = [
    {
      id: 2,
      arabicName: "جزء من المبلغ",
      englishName: "Part of the amount"
    }
  ];
          ...
          <div className="flex gap-2">
            ...
            <Dialog>
              ...
              <DialogContent dir="rtl">
                <DialogHeader>
                  <DialogTitle className="text-xl font-semibold mb-4 text-right">إضافة تأمين طبي</DialogTitle>
                </DialogHeader>
          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-[#004e89] hover:bg-[#004e89]">
                ...
                <TableHead className="text-white text-right font-medium">الاسم بالعربية</TableHead>
                <TableHead className="text-white text-right font-medium">الاسم بالانجليزية</TableHead>
            ...
            <TableBody>
              {mockData.map((row) => (
                <TableRow key={row.id}>
                  ...
                  <TableCell className="font-medium">{row.arabicName}</TableCell>
