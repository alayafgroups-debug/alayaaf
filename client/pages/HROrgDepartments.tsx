...
export default function HROrgDepartments() {
  const mockData = [
    { id: 4, name: "التسويق", branch: "شركة إدارة العياف", manager: "عبدالمجيد شودري", substitute: "نادر القرشي", description: "" },
    { id: 3, name: "إدارة العليا", branch: "الفرع الرئيسي", manager: "نادر القرشي", substitute: "عبدالمجيد شودري", description: "" },
    { id: 1, name: "إدارة الموارد البشرية", branch: "", manager: "عبدالمجيد شودري", substitute: "سعيد محمد نور الحق", description: "" }
  ];
          ...
          <Table className="min-w-[1000px]">
            <TableHeader>
              <TableRow className="bg-[#004e89] hover:bg-[#004e89]">
                <TableHead className="text-white text-right font-medium w-[80px]">رقم الإدارة</TableHead>
                ...
                <TableHead className="text-white text-right font-medium">البديل</TableHead>
