            ...
            <table className="w-full text-sm text-center whitespace-nowrap">
              <thead className="bg-gray-50 text-gray-700 border-b border-gray-200">
                <tr>
                  ...
                  <th className="py-3 px-2 font-medium">المخالفة</th>
                  <th className="py-3 px-2 font-medium">
                    <div className="flex items-center justify-center gap-1">
                      الجزاء <select className="h-6 w-4 opacity-0 absolute"><option></option></select>
                    </div>
                  </th>
                  <th className="py-3 px-2 font-medium">
                    <div className="flex items-center justify-center gap-1">
                  ...
                  <th className="py-3 px-2 font-medium">أنشئ بواسطة</th>
