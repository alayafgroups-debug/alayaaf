...
import { Search, Printer, Download, Eye, Plus, CheckCircle, FileText, CheckCircle2 } from "lucide-react";
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          <div className="bg-[#004e89] text-white p-3 flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-4 w-full md:w-auto">
              <h2 className="text-lg font-bold whitespace-nowrap hidden sm:block">المساءلات</h2>
            ...
            <div className="flex items-center gap-3 w-full md:w-auto justify-between md:justify-end">
              <h2 className="text-lg font-bold sm:hidden">المساءلات</h2>
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-2">
                  <button className="p-1.5 hover:bg-white/10 rounded transition-colors text-white" title="إضافة مساءلة">
            ...
            <table className="w-full text-sm text-center whitespace-nowrap">
              <thead className="bg-gray-50 text-gray-700 border-b border-gray-200">
                <tr>
                  ...
                  <th className="py-3 px-2 font-medium">اسم الإدارة</th>
                  <th className="py-3 px-2 font-medium">تاريخ الإرسال</th>
                  <th className="py-3 px-2 font-medium">المرسل</th>
                  <th className="py-3 px-2 font-medium">
                    <div className="flex items-center justify-center gap-1">
                      المخالفة <select className="h-6 w-4 opacity-0 absolute"><option></option></select>
                    </div>
                  </th>
                  <th className="py-3 px-2 font-medium min-w-[120px]">عنوان المساءلة</th>
                  <th className="py-3 px-2 font-medium">
                    <div className="flex items-center justify-center gap-1">
                      القرار النهائي <select className="h-6 w-4 opacity-0 absolute"><option></option></select>
                    </div>
                  </th>
                  <th className="py-3 px-2 font-medium">
                    <div className="flex items-center justify-center gap-1">
