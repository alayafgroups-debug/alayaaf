  ...
  const mockData = [
    {
      ...
      amount: "6,240.00",
      employeeReply: "موافق عليه",
      replyDate: "2026-02-05 04:28:54",
      status: "موافق عليه",
      addedDate: "2026-02-05 04:28:28"
    }
  ];
  ...
  return (
    <Layout>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4 p-4 bg-gray-50 rounded-lg border">
        ...
        <div>
          <label className="text-sm text-gray-600 mb-1 block">رد الموظف</label>
          <Select defaultValue="all">
            <SelectTrigger>
              <SelectValue placeholder="الكل" />
            </SelectTrigger>
        ...
        <Table className="min-w-[1200px]">
          <TableHeader>
            <TableRow className="bg-[#004e89] hover:bg-[#004e89]">
              ...
              <TableHead className="text-white text-right font-medium">المبلغ</TableHead>
              <TableHead className="text-white text-center font-medium">رد الموظف</TableHead>
              <TableHead className="text-white text-right font-medium">تاريخ الرد</TableHead>
          ...
          <TableBody>
            {mockData.map((row) => (
              <TableRow key={row.id}>
                ...
                <TableCell>{row.replyDate}</TableCell>
                <TableCell className="text-center">
                  <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-emerald-100 text-emerald-800">
                    {row.status}
                  </span>
